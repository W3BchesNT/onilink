...
; Подключаем стандартный макрос FASM для автоматической сборки сложных ресурсов
...
; ДОБАВИЛИ СЮДА: Теперь FASM сначала прочитает функции UIX_ParseCmdLine и UIX_LoadImage
include 'lib/picaso.inc'

include 'gui.inc'            
include 'logic.inc'          

; ТРЮК ДЛЯ СОВМЕСТИМОСТИ: связываем старое имя из wincore.inc с нашей новой процедурой
...
; ==============================================================================
; НАДЕЖНАЯ СЕКЦИЯ РЕСУРСОВ: СБОРКА ЧЕРЕЗ СТАНДАРТНЫЙ МАКРОС FASM
; ==============================================================================
section '.rsrc' resource data readable
  ...
  ; Макрос автоматически распарсит ваш мультиформатный 256x256 .ico файл
